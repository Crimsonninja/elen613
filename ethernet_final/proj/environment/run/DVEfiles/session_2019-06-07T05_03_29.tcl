...
# DVE full session
# Saved on Thu Jun 6 00:22:07 2019
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{292 93} {1595 793}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 211} {height 442} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 223} {height 442} {dock_state left} {dock_on_new_line true} {child_data_colvariable 152} {child_data_colvalue 17} {child_data_coltype 59} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1303} {height 163} {dock_state bottom} {dock_on_new_line true}}
